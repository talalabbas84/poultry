...
class Home extends React.Component {
  ...
  getData = async () => {
    ...
    try {
      const res = await axios.get(
        `https://www.pakpoultryhub.com/api/shed_category_by_user.php?user_id=${await AsyncStorage.getItem(
          'user_id',
        )}`,
      );
  ...
  deleteHandler = async (id) => {
    ...
    axios({
      method: 'post',
      url: 'https://www.pakpoultryhub.com/api/shed_delete.php',
      data: body,
      headers: {
        ...
        <View
          ...
          <View style={styles.row}>
            <View>
              <View style={styles.row}>
                <Text>Capacity</Text>
                <Text style={styles.blackText}>{item.capacity}</Text>
              </View>

              <View style={styles.row}>
                <Text>Rent</Text>
                <Text style={styles.blackText}>{item.rent}</Text>
              </View>
  ...
  render() {
    return (
      <View style={{flex: 1, backgroundColor: colors.backColor}}>
        ...
        <Text style={styles.title}> Sheds Ads </Text>
        <FlatList
